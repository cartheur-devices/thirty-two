...
Public Class Form1
    ...
    Private Sub DiscoverAsyncToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DiscoverAsyncToolStripMenuItem.Click

    End Sub

    Private m_btco As BluetoothComponent

    Public Sub DiscoDevicesAsync()
        If m_btco Is Nothing Then
            m_btco = New BluetoothComponent()
            AddHandler m_btco.DiscoverDevicesComplete, AddressOf HandleDiscoDevicesAsync
        End If
        m_btco.DiscoverDevicesAsync(255, True, True, True, False, Nothing)
    End Sub
    ...
    '===========================================================================
#Region "Discovery"
    Private Sub ButtonDiscoverDevices_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonDiscoverDevices.Click, ButtonClientDiscoverDevices.Click, MenuItemDiscoverAll.Click
    ...
    Private Sub ButtonDiscoverDevicesDiscoverableOnly_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemDiscoverRememberedOnly.Click, MenuItemDiscoverDiscoverableOnly.Click
...
#Region "Client"
    ...
    Private Sub ButtonConnect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles buttonConnect.Click
        ...
        If Me.CheckBoxUsePin.Checked Then
            BluetoothSecurity.SetPin(selectedDevice.DeviceAddress, TextBoxPin.Text)
        End If
        '
        Try
...
#End If
        ...
        Try
            While True
                ...
                If CheckBoxServerLoopback.Checked Then 'TODO !!!!! cross-thread UI access !!!!!
